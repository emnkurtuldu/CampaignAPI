...
using Campaign.Application.Behaviors;
...
using CampaignAPI.Configurations;
...
namespace CampaignAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped(typeof(IApplicationContextDB), typeof(ApplicationContextDB));
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            SystemSettings.SystemTime = new TimeSpan(0);
            using (var serviceScope = app.ApplicationServices.GetRequiredService<IServiceScopeFactory>().CreateScope())
            {
                try
                {
                    serviceScope.ServiceProvider.GetService<ApplicationContextDB>().Database.Migrate();
                }
                catch
                {
                    throw;
